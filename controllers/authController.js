...
exports.register = async (req, res) => {
  ...
  try {
    ...
    const heroData = await homeHeroService.getLatestHomeHeroAnyLanguage();
    ...
    await authService.deleteUnusedVerificationCodes(email);
...
exports.verify = async (req, res) => {
  try {
    ...
    const record = await authService.findValidVerificationCode({ email, code });
    if (!record) {
    ...
    await authService.markVerificationCodeUsed(record.id);
